...
MODEL    = os.getenv("DASHSCOPE_MODEL", "qwen3-8b")
RETRIES  = int(os.getenv("LLM_RETRIES", "2"))
RETRY_BASE_SLEEP = float(os.getenv("LLM_RETRY_BASE_SLEEP", "1.0"))
...
def call_llm(messages: list[dict], retries: int | None = None) -> str:
